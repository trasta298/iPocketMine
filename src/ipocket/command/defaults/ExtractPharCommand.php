...
class ExtractPharCommand extends VanillaCommand{
	...
	public function __construct($name){
		...
		$this->setPermission("ipocket.command.extractphar");
	}
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		$folderPath = $sender->getServer()->getPluginPath().DIRECTORY_SEPARATOR . "iPocket-iTX" . DIRECTORY_SEPARATOR . basename($args[0]);
