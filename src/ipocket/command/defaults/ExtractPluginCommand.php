...
class ExtractPluginCommand extends VanillaCommand{
	...
	public function __construct($name){
		...
		$this->setPermission("ipocket.command.extractplugin");
	}
	...
	public function execute(CommandSender $sender, $commandLabel, array $args){
		...
		$folderPath = Server::getInstance()->getPluginPath().DIRECTORY_SEPARATOR . "iPocket-iTX" . DIRECTORY_SEPARATOR . $description->getName()."_v".$description->getVersion()."/";
